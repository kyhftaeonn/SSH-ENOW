...
```
apt install -y && apt update -y && apt upgrade -y && wget -q https://raw.githubusercontent.com/kyhftaeon/SSH-ENOW/GM/ubu20-deb10-stable.sh && chmod +x ubu20-deb10-stable.sh && ./ubu20-deb10-stable.sh
```
...
```
wget -q https://raw.githubusercontent.com/kyhftaeon/SSH-ENOW/GM/update.sh && chmod +x update.sh && ./update.sh
```
